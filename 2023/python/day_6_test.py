...
def test_part1_real_case():
		assert part1(open('2023/input/day-6.input.txt').read().splitlines()) == 74698

def test_part2_test_case():
		assert part2(open('2023/input/day-6.test.txt').read().splitlines()) == 71503

def test_part2_real_case():
		assert part2(open('2023/input/day-6.input.txt').read().splitlines()) == 27563421