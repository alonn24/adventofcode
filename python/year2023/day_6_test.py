import pytest
from python.year2023.day_6 import part1, beat_record_ways, part2
...
def test_part1_real_case():
    assert part1(
        open(Path('inputs/2023/day-6.input.txt')).read().splitlines()) == 74698


def test_part2_test_case():
    assert part2(
        open(Path('inputs/2023/day-6.test.txt')).read().splitlines()) == 71503
