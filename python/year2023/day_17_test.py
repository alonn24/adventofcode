from python.year2023.day_17 import find_heat_loss
from pathlib import Path


def test_day17_part1_testcase():
    with open(Path('inputs/2023/day-17.test.txt'), 'r') as file:
        data = file.read()
        assert find_heat_loss(data) == 102


def test_day17_part1_realcase():
    with open(Path('inputs/2023/day-17.input.txt'), 'r') as file:
        data = file.read()
