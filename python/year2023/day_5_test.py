import pytest
import numpy as np
from python.year2023.day_5 import part1, part2, map_ranges
from pathlib import Path


def test_part_1_test_case():
    input = open(Path('inputs/2023/day-5.test.txt')).read()
    assert part1(input) == 35


def test_part_1_real_case():
    input = open(Path('inputs/2023/day-5.input.txt')).read()
