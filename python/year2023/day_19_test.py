from python.year2023.day_19 import part1, part2
from pathlib import Path


def test_day19_part1_testcase():
    with open(Path('inputs/2023/day-19.test.txt'), 'r') as file:
        case = file.read()
        assert part1(case) == 19114


def test_day19_part1_realcase():
    with open(Path('inputs/2023/day-19.input.txt'), 'r') as file:
        case = file.read()
