import pytest
from python.year2023.day_10 import part1, part2
...
def test_day10_part1_real_case():
    assert part1(open(Path("inputs/2023/day-10.input.txt")).read()) == 6773
...
def test_day10_part2_real_case():
    assert part2(open(Path("inputs/2023/day-10.input.txt")).read()) == 493
