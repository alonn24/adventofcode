from python.year2023.day_12 import part1, part2, get_row_combinations
...
def test_day12_part1_test_case():
    with open(Path("inputs/2023/day-12.test.txt"), "r") as file:
        assert part1(file.read()) == 21


def test_day12_part1_real_case():
    with open(Path("inputs/2023/day-12.input.txt"), "r") as file:
